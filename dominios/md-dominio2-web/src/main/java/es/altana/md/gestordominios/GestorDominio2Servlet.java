 ...
 *
 */
public class GestorDominio2Servlet extends JAXMServlet implements ReqRespListener {
	protected static Log log = LogFactory.getLog(GestorDominio2Servlet.class.getName());
	...
	public SOAPMessage onMessage(SOAPMessage msg) {
        ...
        try {
            ...
            String sFichero = "C:/huecoPet.txt";
            File fichero = new File(sFichero);
            BufferedWriter bw = new BufferedWriter(new FileWriter(fichero));
            bw.write(content);
            bw.close();
            */
            messageResp = crearMensaje("C:/Mensaje_Respuesta2.xml");
            /*
            String content = extractMessageContent(messageResp);
            String sFichero = "C:/Tomcat 6.0/huecos/huecoResp.txt";
            ...
            */
            ...
            mensaje = new String("<ERROR>Se ha producido una excepción al intentar obtener el mensaje de respuesta</ERROR>");
            try {
